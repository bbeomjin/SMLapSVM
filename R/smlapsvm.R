...
find_theta.smlapsvm = function(y, anova_kernel, L, cmat, c0vec, n_class, lambda, lambda_I, lambda_theta = 1, eig_tol_D = 1e-15, eig_tol_I = 1e-15)
{
  n = NROW(cmat)
  n_l = length(y)
  n_u = n - n_l
...
smlapsvm_compact = function(anova_K, L, theta, y, lambda, lambda_I, epsilon = 1e-6, eig_tol_D = 1e-15, eig_tol_I = 1e-15)
{
